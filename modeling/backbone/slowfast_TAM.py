...
class FastPath(nn.Module):
    def __init__(self, cfg):
        ...
        self.tam_thershold = cfg.MODEL.BACKBONE.SLOWFAST.THRESHOLD
...
class SlowFast_TAM(nn.Module):
    def __init__(self, cfg):
        super(SlowFast_TAM, self).__init__()
        self.cfg = cfg.clone()
