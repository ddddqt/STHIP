...
def fusion_block(x,y,keep_rate,enhance_weights,csnum_heads):
    attn = AFF(dim=1024, num_heads=8, csnum_heads=csnum_heads,qkv_bias=False, qk_scale=1, attn_drop=0., proj_drop=0.,
